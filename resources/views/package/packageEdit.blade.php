              ...
              <form action="{{route('packages.update',$package->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" required="" name="title" id="exampleInputPassword1" value="{{$package->title}}" placeholder="Title">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1">New Price</label>
                    <input type="number" class="form-control" name="price" id="new_price" value="{{$package->price}}" placeholder="Price">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Description</label>
                    <textarea class="ckeditor" required="" id="summernote" name="description" > {{$package->description}} </textarea>
                  </div>
