...
<div class="card card-primary card-outline">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="post" action="{{route('subcategory.update',$category->id)}}" >
                @csrf
                @method('put')
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select required  name="category_id" class="form-control" id="exampleInputEmail1">
                      ...
                      <option value="{{$row->id}}" @if($row->id == $category->category_id) selected @endif>{{$row->category_name}}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="form-group">
